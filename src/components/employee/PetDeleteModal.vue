  ...
  <div v-if="open" class="modal-backdrop" @click.self="$emit('close')">
    <div class="modal">
      ...
      <div class="modal-body">
        <p class="msg">¿Desea eliminar esta mascota? Esta accion no se puede deshacer.</p>
        <p v-if="hasCitas" class="warning">
...
.modal-header { padding: 20px 24px; border-bottom: 1px solid #f3f4f6; }
...
.msg { font-size: 14px; color: #374151; }
.warning {
