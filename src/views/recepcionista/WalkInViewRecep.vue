...
async function registrar() {
  ...
  const { data, execute } = ApiUseFetch('/recep/walk-in')
    .post({
      ...
      <div class="walkin-card">
        ...
        <div class="walkin-col">
          ...
          <div class="walkin-field">
            ...
            <button v-if="clienteId" @click="limpiarCliente" class="walkin-change-btn">
              × Cambiar cliente
            </button>
          </div>
          ...
          <div class="walkin-field">
            ...
            <div v-else class="walkin-pet-grid">
              <button
                ...
                :class="[
                  'walkin-pet-card',
                  mascotaId === mascota.id ? 'walkin-pet-card--active' : '',
                ]"
              >
...
.walkin-btn-primary:hover {
  background: #185fa5;
}
.walkin-btn-primary:disabled {
  opacity: 0.55;
  cursor: not-allowed;
}
